...
In the next chapter, We will explore some additional options for formatting the data for use in tinyVAST, and how to ensure that the necessary accessory objects and dataframes are ready.
